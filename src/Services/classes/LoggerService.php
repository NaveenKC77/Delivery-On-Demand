...
class LoggerService extends DynamoDbService implements LoggerServiceInterface
{
    ...
    public function getLogsByEntityAction(string $entityType, string $action): array
    {
    ...
    public function getLogsByentityItem($entityType, $entityId): array
    {
        $queryParam = [
            'TableName' => self::TABLE_NAME,
